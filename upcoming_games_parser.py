...
# Класс, который получает код запроса, на который ему нужно отправить пользователю
# расписание ближайших матчей по игре и лиге, которые выбрал пользователей с помощью клавиатуры
class UpcomingGamesParser:
    ...
    # Делает скриншот нужной страницы сайта, обрезает и отправляет пользователю
